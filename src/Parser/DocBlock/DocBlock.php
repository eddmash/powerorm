...
namespace Eddmash\PowerOrm\Parser\DocBlock;

use Eddmash\PowerOrm\Parser\Preg;
...
class DocBlock
{
    ...
    public function addLine($post, $lineContent)
    {
        array_splice($this->lines, $post, 0, [new Line($lineContent)]);
    }
