...
class DbHelper
{
    public static function createQueryset($model, $query = null, $params = '', $query_builder_override = null)
    {
        return createQueryset($model, $query, $params, $query_builder_override);
    }
}
 ...
 */
function createQueryset($model, $query = null, $params = '', $query_builder_override = null)
{
