...
class Application
{
    ...
    public static function setup($config, &$composerLoader = null)
    {
        ...
        if ($composerLoader && $settings->getAutoloadModels()) :
            $composerLoader->setPsr4($modelsNamespace, $settings->getModelsPath());
            $composerLoader->setPsr4($migrationsNamespace, $settings->getMigrationPath());
        endif;
