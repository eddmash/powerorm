...
class Migration extends Object
{
    ...
    public function as_string()
    {
        ...
        $dependencies = $this->get_dependency();

        $indent = (count($dependencies) <= 1) ? false : 3;

        return sprintf(template(), $imports, $this->name, Tools::stringify($dependencies, $indent), $ops);
    }
...
use eddmash\powerorm\\migrations\\Migration;
%1\$s
