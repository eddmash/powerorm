...
class MigrationFile
{
    ...
    public function getContent() {
        ...
        return sprintf($this->getFileTemplate(), $importPaths,
            $this->migration->getName(), Tools::stringify($dependencies, $indent), $opContent);
    }
    ...
    private function getFileTemplate()
    {
        ...
        $content->addItem('<?php');
        $content->addItem(PHP_EOL.sprintf('/**Migration file generated by PowerOrm(%s)*/', POWERORM_VERSION).PHP_EOL);
