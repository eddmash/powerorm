...
I created this project because i required a lightweight easy to use orm that i could use when working on projects using
codeigniter with the least amount of configuration . sort of plug and play if you will. while at the same time reducing
repetition and providing a consistent way to deal with databases.
