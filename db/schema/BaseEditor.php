...
abstract class BaseEditor extends ForgeClass
{
    ...
    public function _alter_field(BaseModel $model, Field $previous_field, Field $present_field, $previous_type, $present_type){
        ...
        // if old state of field was unique but the new state of field is not unique and we are not adding a primary key
        ...
        // todo did type of pk change ?
        // todo if so also update the fields that point to us
